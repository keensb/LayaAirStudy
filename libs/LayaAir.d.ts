...
declare module laya.display {
	...
	class Node extends laya.events.EventDispatcher  {
		 ...
		 * @return 组件。
		 */
		addComponentIntance(component:laya.components.Component):any;//这里传的是实例，不是类型，别乱改
		...
		addComponent<T extends laya.components.Component>(componentType: new ()=> T):T;
		...
		getComponent<T extends laya.components.Component>(componentType: new ()=> T):T;
